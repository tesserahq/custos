import pytest
from app.schemas.authorization import AuthorizationRequest, RoleAssignmentRequest, PermissionRequest
...
def test_permissions_endpoint(client, user_id):
    ...
    policy_success = casbin_service.add_policy("editor", "document", "edit", domain="test-domain")
    ...
    user_permissions = casbin_service.get_user_permissions(user_id, domain="test-domain")
